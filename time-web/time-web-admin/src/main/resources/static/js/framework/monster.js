    ...
    tips: function (message, type = "success") {
        ...
        inner.prototype = {
            ...
            build: function (message, key) {
                let html = [],innerStyle="height:100%;",monsterStyle='box-shadow:0 0 4px rgba(0,0,0,.2);font-family:"Microsoft YaHei",SimSun;position:fixed;border-radius: 4px;height: 40px;color: #fff;padding:0 15px;background: #4c93ff;top:74px;left:50%;margin-left:-112px;opacity:1;display:block;z-index:95;';

...
<form class="form-signin">
    <!--logo-->
    <div class="logo">
        <img src="/img/login/login_logo.png" width="50" height="40"><h3>xxxxxxx系统</h3>
    </div>
    <!--用户名-->
    <div class="row">
        <div class="col-12">
            ...
            <!--错误信息-->
            <div class="error-notice username-error-notice"></div>
        </div>
    </div>
    <!--密码-->
    <div class="row">
        <div class="col-12">
            ...
            <!--错误信息-->
            <div class="error-notice password-error-notice"></div>
        </div>
    </div>
    <!--验证码-->
    <div class="row mb-3">
        <div class="col-12">
            <div class="input-group">
                ...
                <img class="captcha" src="/captcha" alt="图片验证码">
                <input type="text" name="captcha" class="form-control" placeholder="验证码">
            </div>
            <!--错误信息-->
            <div class="error-notice captcha-error-notice"></div>
        </div>
    </div>
    <!--按钮-->
    <div class="row">
        <div class="col-12">
            <div class="input-group mb-2">
                <button type="button" id="submit" class="btn btn-warning btn-block">
                    登录
                </button>
            </div>
        </div>
